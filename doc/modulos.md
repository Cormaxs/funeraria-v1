# Backend funeraria modulos

Backend de funeraria (MVP), es una API rest, dividida en 3 modulos individuales reutulizables en futuros proyectos.
...
[Documentacion de auth](./autenticacion.md)
...
[Documentacion de Asociados](./asociados.md)
...
[Documentacion de Inventario](./ges-inv.md)
